...
```js
import logoImg from './assets/full_logo.webp'
```
...
7. Tour de l'accomplissement
    ...
    d. trésor à trouver : une graine
8. Flash de vie future
    a. animation de plusieurs scènes de vie 
    b. plante qui grandit de plus en plus
9. La graine donne finalement son premier fruit : le trésor final
